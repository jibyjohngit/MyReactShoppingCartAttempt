...
// it off line capabilities. The drawback is users will only see deployed updates 
// on subsequent visits to a page, after all the
...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {]
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        // Since I am running locally. Check service worker exists or not.
